...
internal class OutputSurface : SurfaceTexture.OnFrameAvailableListener {
    ...
    var surface: Surface? = null
        private set
    private val mFrameSyncObject = java.lang.Object()     // guards mFrameAvailable
    ...
    /**
     * Creates instances of TextureRenderer and SurfaceTexture, and a Surface associated
    ...
    private fun checkEglError(msg: String) {
        ...
        while (true) {
            ...
            if (error == EGL10.EGL_SUCCESS) break
